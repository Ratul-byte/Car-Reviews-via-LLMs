...
- ### Summarization
  ...
  - Uses `evaluate` metrics: `toxicity` and `regard` to assess the safety of generated summaries.
...
## License / Attribution
- Models and libraries are used under their respective licenses (Datacamp, Hugging Face model cards, Apache/MIT/other). Check each model card for details.
